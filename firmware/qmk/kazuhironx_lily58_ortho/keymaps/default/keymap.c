...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_split_5x6_5(
        ...
        KC_TRNS, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_PIPE,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, KC_TRNS,
    ...
    [_RAISE] = LAYOUT_split_5x6_5(
        ...
        KC_TRNS, KC_ESC,  KC_TAB,  KC_BSPC, KC_DEL,  KC_ENT,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_SCLN, KC_TRNS,
